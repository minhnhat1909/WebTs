                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="product-pic-zoom">
                                <img class="product-big-img" src="front/img/products/{{ $product->productimages[0]->path }}" alt="Sản phẩm chưa có hình ành">
                                <div class="zoom-icon">
                            ...
                            <div class="product-thumbs">
                                <div class="product-thumbs-track ps-slider owl-carousel">
                                    ...
                                    <div class="pt active" data-imgbigurl="front/img/products/{{ $productImage->path }}">
                                        <img src="front/img/products/{{ $productImage->path }}"alt="Not img">
                                    </div>
                                    @endforeach
                                </div>
                            </div>
                    ...
                    <div class="product-tab">
                        <div class="tab-item">
                            <ul class="nav" role="tablist">
                                ...
                                <li><a href="#tab-2" data-toggle="tab" role="tab">SPECCIFICATIONS</a></li>
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane fade" id="tab-2" role="tabpanel">
                                    <div class="specification-table">
                                        <table>
                                            <tr>
                                                <td class="p-catagory">Costomer Rating</td>
                                                <td>
                                                    <div class="pd-rating">
                                                        @for($i=1;$i<=5;$i++)
                                                            @if($i<=$avgRating)
                                            ...
                                            <tr>
                                                <td class="p-catagory">Avalibility</td>
                                                <td>
                                                    <div class="cart-stock">{{$product->qty}} in stock</div>
                                                </td>
                                            </tr>
                                            <tr>
                                ...
                                <div class="tab-pane fade" id="tab-3" role="tabpanel">
                                    <h4><span>{{ count($product->productcomment) }}</span> Comments</h4>
                                    <div class="customer-review-option">
                                        <div class="comment-option">
                                           @foreach($product->productcomment as $productcomments)
                                                <div class="co-item">
                                                    <div class="avatar-pic">
                                                        <img src="front/img/product-single/{{$productcomments->user->avatar ?? 'avtnologin.jpg'}}" alt="">
                                                    </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="product-item">
                        <div class="pi-pic">
                            <img src="front/img/products/{{$relatedProduct->productImages[0]->path}}" alt="k co hinh anh">
